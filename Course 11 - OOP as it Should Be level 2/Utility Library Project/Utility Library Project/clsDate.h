...
private:
    ...
    enum _enDateCompare { _Before = -1, _Equal = 0, _After = 1 };
...
public:
    ...
    {
        clsDate Date1 = GetDateFromDayOrderInYear(TotalDays, Year);
        _Day = Date1.Day;
        _Month = Date1.Month;
        _Year = Date1.Year;
    ...
    {
        clsDate DateStruct;
        vector<string> vDate = clsString::Split(DateString, Delim);
    ...
    // ===================================================
    //  LEAP YEAR & MONTH/YEAR CALCULATIONS 
    // ===================================================
    ...
    static _enDateCompare CompareDates(const clsDate& Date1, const clsDate& Date2)
    {
        if (IsDate1BeforeDate2(Date1, Date2))
            return _enDateCompare::_Before;

        if (IsDate1EqualDate2(Date1, Date2))
            return _enDateCompare::_Equal;


        return _enDateCompare::_After;

    }

    _enDateCompare CompareDates(const clsDate& Date2)
    {
